...
INSERT INTO `f_admin` VALUES ('1', 'admin', 'MTIzNDU2', '1', '18840918752', '1719847255@qq.com', '1', '1542655038', '1', '1', '1545211895', '20181202\0457073da7fde88c2485ca21d8f97269.jpg', '具有至高无上的管理权力！！！');
INSERT INTO `f_admin` VALUES ('11', 'xiaoshou', 'MTExMTEx', '0', '18578999999', '2345678@qq.com', '12', '1543566477', '0', '1', '1545226159', '20181202\92d61df595f41fb9a3c065ca86e9ada5.jpg', '销售管理员');
INSERT INTO `f_admin` VALUES ('10', 'bianji', 'MTIzNDU2', '1', '18885175642', '2345678@qq.com', '11', '1543565944', '0', '1', '1544688857', '', '');
...
INSERT INTO `f_article` VALUES ('20', 'hhhh', 'cccccc', '&lt;p&gt;ddddd&lt;/p&gt;', '0', '1544704613');
...
INSERT INTO `f_evaluation` VALUES ('1', 'PHP面试题', 'PHP面试题宝典', '1545220191', '90', '1');
...
INSERT INTO `f_evaluation_info` VALUES ('1', '1', 'single', '<p><span style="font-size:14px;font-family:宋体">给定一个用逗号分隔一组值的字符串，以下哪个函数能在仅调用一次的情况下就把每个独立的值放入一个新创建的数组？</span></p>', 'D', '<p><span style=";font-family:宋体">strstr()</span></p>_@<p><span style="font-size:14px;font-family:宋体">不可能只调用一次就完成</span></p>_@<p><span style="font-size:14px;font-family: 宋体">extract()</span></p>_@<p><span style="font-size:14px;font-family: 宋体;color:blue">explode()</span></p>');
INSERT INTO `f_evaluation_info` VALUES ('2', '1', 'single', '<p><span style="font-size:14px;font-family:宋体">如果用</span><span style="font-size: 14px;font-family:&#39;Calibri&#39;,&#39;sans-serif&#39;">+</span><span style="font-size:14px;font-family:宋体">操作符把一个字符串和一个整型数字相加，结果将怎样？</span></p>', 'C', '<p><span style="font-size:14px;font-family:宋体">解释器输出一个类型错误</span></p>_@<p><span style="font-size:14px;font-family:宋体">字符串将被转换成数字，再与整型数字相加</span></p>_@<p><span style="font-size:14px;font-family:宋体;color:blue">字符串将被丢弃，只保留整型数字</span></p>_@<p><span style="font-size:14px;font-family:宋体">字符串和整型数字将连接成一个新字符串</span></p>');
INSERT INTO `f_evaluation_info` VALUES ('3', '1', 'single', '<p><span style="font-size:14px;font-family:宋体">以下脚本输出什么？</span></p><p><span style="font-size:14px;font-family:宋体">&lt;?php<br/></span></p><p><span style="font-size:14px;font-family:宋体"></span></p><p><span style=";font-family:宋体">$s = &#39;12345&#39;;</span></p><p><span style=";font-family:宋体">&nbsp; $s[$s[1]] = &#39;2&#39;;</span></p><p><span style=";font-family:宋体">&nbsp; echo $s;</span></p><p><span style=";font-family:宋体">?&gt;</span></p><p><span style="font-size:14px;font-family:宋体"><br/></span><br/></p>', 'B', '<p><span style="font-size:14px;font-family: 宋体">12345</span></p>_@<p><span style="font-size:14px;font-family: 宋体;color:blue">12245</span></p>_@<p><span style="font-size:14px;font-family: 宋体">22345</span></p>_@<p><span style="font-size:14px;font-family: 宋体">11345</span></p>');
INSERT INTO `f_evaluation_info` VALUES ('4', '1', 'multi', '<p><span style="font-size:14px;font-family:宋体">下面建立与</span><span style="font-size: 14px;font-family:&#39;Calibri&#39;,&#39;sans-serif&#39;">MySQL Server</span><span style="font-size:14px;font-family:宋体">的连接语法正确的是：</span><span style="font-size: 14px;font-family:&#39;Calibri&#39;,&#39;sans-serif&#39;">[&nbsp; ]</span></p>', 'B_@D', '<p><span style="font-size:14px;font-family: 宋体">$link=connect(&quot;host_name&quot;,&quot;user_name&quot;,&quot;password&quot;);</span></p>_@<p><span style="font-size:14px;font-family: 宋体">$link=mysql_connect(&quot;host_name&quot;,&quot;user_name&quot;,&quot;password&quot;);</span></p>_@<p><span style="font-size:14px;font-family: 宋体">$link=mysqlconnect(&quot;host_name&quot;,&quot;user_name&quot;,&quot;password&quot;);</span></p>_@<p><span style="font-size:14px;font-family: 宋体">$link=mysql_pconnect(&quot;host_name&quot;,&quot;user_name&quot;,&quot;password&quot;);</span></p>');
INSERT INTO `f_evaluation_info` VALUES ('5', '1', 'recognized', '<p>PHP是一种服务端脚本语言</p>', '0', '');
INSERT INTO `f_evaluation_info` VALUES ('6', '1', 'short', '<p><span style="font-size:14px;font-family: 宋体">Http </span><span style="font-size:14px;font-family:宋体">和Https的区别</span></p>', '<p style="text-indent:28px"><span style=";font-family:宋体">第一：http是超文本传输协议，信息是明文传输，https是具有安全性的ssl加密传输协议</span></p><p style="text-indent:28px"><span style=";font-family:宋体">第二：http和https使用的是完全不同的连接方式，端口也不一样，前者80 或者443</span></p><p><span style="font-size:14px;font-family:宋体">第三：http连接很简单，是无状态的。https协议是由ssl+http协议构建的可进行加密传输，身份认证的网络协议。</span></p>', '');
INSERT INTO `f_evaluation_info` VALUES ('7', '1', 'short', '<p><span style="font-size:14px;font-family:宋体">什么方法来加快页面的加载速度</span></p>', '<p style="text-indent:28px"><span style=";font-family:宋体">1</span><span style=";font-family:宋体">，用到服务器资源时在打开，不用时，立即关闭服务器资源。</span></p><p style="text-indent:28px"><span style=";font-family:宋体">2</span><span style=";font-family:宋体">，数据库添加索引</span></p><p style="text-indent:28px"><span style=";font-family:宋体">3</span><span style=";font-family:宋体">，页面可生成静态</span></p><p style="text-indent:28px"><span style=";font-family:宋体">4</span><span style=";font-family:宋体">，图片等大文件单独放在一个服务器</span></p><p style="text-indent: 28px;"><span style=";font-family:宋体">5</span><span style=";font-family:宋体">，能不查询数据库的尽量不去数据取数据，可以放在缓存中。</span></p>', '');
INSERT INTO `f_evaluation_info` VALUES ('8', '1', 'short', '<h3><span style="font-size:14px;line-height:172%;font-family:宋体">表单中 get与post提交方法的区别?</span></h3>', '<p><span style="font-size:14px;font-family: 宋体">get</span><span style="font-size:14px;font-family:宋体">是发送请求HTTP协议通过url参数传递进行接收,而post是实体数据,可以通过表单提交大量信息。</span></p>', '');
INSERT INTO `f_evaluation_info` VALUES ('9', '1', 'short', '<p><span style="font-size:14px;font-family: 宋体">echo ,print,print_r&nbsp;</span><span style="font-size:14px;font-family:宋体">的区别：</span></p>', '<p style="text-indent:28px"><span style=";font-family:宋体">echo&nbsp;</span><span style=";font-family:宋体">是php语句，无返回值。</span></p><p style="text-indent:28px"><span style=";font-family:宋体">print,print_r</span><span style=";font-family:宋体">是函数,有返回值。<br/> &nbsp;&nbsp;&nbsp; print（）&nbsp;&nbsp;&nbsp; 只能打印出简单类型变量的值(如int,string)&nbsp; </span></p><p style="text-indent: 28px;"><span style=";font-family:宋体">print_r</span><span style=";font-family:宋体">（） 可以打印出复杂类型变量的值(如数组,对象)&nbsp; <br/> &nbsp;&nbsp;&nbsp; echo&nbsp;&nbsp;&nbsp;&nbsp; 输出一个或者多个字符串</span></p>', '');
INSERT INTO `f_evaluation_info` VALUES ('10', '1', 'short', '<p><span style="font-size:14px;font-family: 宋体">session</span><span style="font-size:14px;font-family:宋体">与cookie区别</span></p>', '<p style="text-indent:28px"><strong><span style="font-size:15px">session</span></strong><strong><span style="font-size:15px;font-family:宋体">与</span></strong><strong><span style="font-size:15px">cookie</span></strong><strong><span style="font-size:15px;font-family:宋体">相同：</span></strong><span style="font-family: 宋体">跨页面、不跨用户</span></p><p style="text-indent:28px"><strong><span style="font-size:15px">session</span></strong><strong><span style="font-size:15px;font-family:宋体">与</span></strong><strong><span style="font-size:15px">cookie</span></strong><strong><span style="font-size:15px;font-family:宋体">不相同：</span></strong></p><p style="text-indent:28px">1<span style="font-family:宋体">、</span>session<span style="font-family:宋体">可以存储任意类型的数据，但</span>cookie<span style="font-family:宋体">只能存储字符串</span></p><p style="text-indent:28px">2<span style="font-family:宋体">、</span>cookie<span style="font-family:宋体">产生在服务器端、存储在客户端</span></p><p style="text-indent: 28px;">&nbsp;&nbsp; session<span style="font-family:宋体">产生在服务器端、存储在服务器端</span></p>', '');
...
INSERT INTO `f_members` VALUES ('1', 'fengyi', '123456', '0', '1970', '4', '0', '1719847255@qq.com', '贵州省贵阳市云岩区大营坡长冲农民新村40号', '18885175642');
...
INSERT INTO `f_role_group` VALUES ('10', '普通管理员', '/index.php/admin/Admin/web_chat@/index.php/admin/Admin/evaluation@/index.php/admin/Admin/system_mess@/index.php/admin/Admin/admin_info@/index.php/admin/System/update_pass@/index.php/admin/System/clock_pass@/index.php/admin/System/extraconfig@/index.php/admin/Article/index@/index.php/admin/Article/article_add@/index.php/admin/Article/article_edit@/index.php/admin/Article/article_delete@/index.php/admin/Article/article_toggle@/index.php/admin/Member/index@/index.php/admin/Member/member_type@/index.php/admin/Member/member_add@/index.php/admin/Member/member_edit@/index.php/admin/Member/member_toggle@/index.php/admin/Member/member_password@/index.php/admin/Member/member_delete@/index.php/admin/Member/export@/index.php/admin/Order/index@/index.php/admin/Order/delete@/index.php/admin/System/index@/index.php/admin/Point/index@/index.php/admin/System/add_system_message@/index.php/admin/System/log@/index.php/admin/System/echarts@/index.php/admin/System/backups@/index.php/admin/System/export_database@/index.php/admin/System/database_import@/index.php/admin/System/downdload_files@/index.php/admin/System/downdload_files@/index.php/admin/System/file_delete@/index.php/admin/System/sqlReback@/index.php/admin/Evaluation/index@/index.php/admin/Evaluation/add@/index.php/admin/Wechat/base_config@/index.php/admin/Wechat/menu_config@/index.php/admin/Wechat/fans_list', '1', '拥有除权限管理之外的所有权利');
