<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"../app/admin/view/public\dispatch_jump.html";i:1548179400;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
.tranjump{background: url(/images/tac.png) no-repeat;background-position: center center;background-size:cover;width: 100%;height: 100%;}
...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
		<div class="rectangle_box">
			<div class="borderopely">
				...
				<div class="tipbox" style="">
					...
					<div class="ma-to-10">
						...
						<a href="/admin/index/index" target="_parent" class="waittim ht-colblue">系统后台</a>
					</div>
				</div>
				<!--修改成功-e-->
				<?php }else{?>
			...
			<div class="recigle">
				<p>Copyright&copy;2018-2019<em class="copyright"><a class="copyright" href="/"><?php echo (isset($web_info['web_name']) && ($web_info['web_name'] !== '')?$web_info['web_name']:' FlyFly 管理系统'); ?> v1.0.0</a></em></p>
				<p><em class="copyright"><a class="copyright" href="/"><?php echo (isset($web_info['web_name']) && ($web_info['web_name'] !== '')?$web_info['web_name']:'FlyFly'); ?></a></em>出品</p>
			</div>
		</div>
