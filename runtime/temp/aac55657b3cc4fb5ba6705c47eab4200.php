<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"../app/admin/view/dictionary\data_dictionary.html";i:1548615072;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
        ...
        <table class="layui-table" lay-data="{height:'full-100', cellMinWidth: 80, url:'data_dictionary_info', toolbar:'#demoTable', page:true, id:'idTest',initSort: {field:'id', type:'desc'}}" lay-filter="archives">
            <thead>
                <tr>
                    ...
                    <th lay-data="{field:'is_available'}">状态</th>
    ...
    <script type="text/html" id="demoTable">
        ...
        <button class="layui-btn layui-btn-sm" onclick="x_admin_show('新增','dictionary_add')"><i class="layui-icon layui-icon-add-circle-fine"></i>新增</button>
    </script>

    <script type="text/html" id="barDemo">
        <a class="layui-btn layui-btn-xs" lay-event="detail" onclick="x_admin_show('修改','dictionary_edit?id={{d.id}}')">修改</a>
    ...
    layui.use(['form','layer','laydate','table'], function(){
        ...
        var $ = layui.$, active = {
            ...
            ,reload: function(){
                ...
                console.log(post)
                $.ajax({
                    url: "<?php echo url('admin/Dictionary/data_dictionary_info'); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: post,
                    success: function(res) {
