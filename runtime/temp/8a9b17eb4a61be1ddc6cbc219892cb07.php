<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"../app/admin/view/admin\web_chat.html";i:1553350287;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="layui-anim layui-anim-up">
    ...
    layui.use(['form','layer','layim'], function(layim){
        ...
        layim.config({
            init: {
                // url: '/static/lib/layui/getList.json'
                url: "<?php echo url('admin/Admin/get_friends_list'); ?>"
                ,data: {}
                //配置客户信息
                ,mine: {
                    "username": "纸飞机" //我的昵称
                    ...
                    ,"avatar": "/static/admin/images/face.jpg" //我的头像
                }
            }
            ,members: {
                url: '/static/lib/layui/getmsg.json' //接口地址（返回的数据格式见下文）
        ...
        $(function(){
            ...
            ws.onopen = function() {
                layer.alert("欢迎使用在线聊天...",{title:'系统提示',closeBtn:0,icon:6},function(){
                    ws.send("<?php echo \think\Request::instance()->session('login.name'); ?>");
                    // layer.alert("给服务端发送一个字符串：tom"); 
                });
                
            };
            ws.onmessage = function(e) {
                layer.alert("收到服务端的 消息：" + e.data);
            };

            ws.onclose = function(e) {
                // 关闭 websocket
                layer.alert("连接已关闭" + e.data);
            };
        })
    </script>
