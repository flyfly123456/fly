<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"../app/admin/view/wechat\material_list.html";i:1547631732;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
        ...
        <table class="layui-table" lay-data="{height:'full-100', cellMinWidth: 80, url:'material_list_info', toolbar:'#demoTable', page:true, id:'idTest',initSort: {field:'id', type:'desc'}}" lay-filter="material">
            <thead>
                <tr>
                    <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                    <th lay-data="{field:'id',sort: true, fixed: true}">ID</th>
                    <th lay-data="{field:'title',width:180}">标题</th>
                    <th lay-data="{field:'media_id', width:280}">media_id / thumb_media_id</th>
                    <th lay-data="{field:'forever',width:180}">类型</th>
                    <th lay-data="{field:'type',width:180}">多媒体</th>
                    <th lay-data="{field:'created_at',width:180}">创建时间</th>
                    <th lay-data="{field:'status',width:180}">状态</th>
    ...
    <script type="text/html" id="demoTable">
        ...
        <button class="layui-btn layui-btn-sm layui-btn-normal push_message_all" data-type="push_message_all" onclick="x_admin_show('新增素材','material_add')"><i class="layui-icon layui-icon-add-circle-fine"></i>新增素材</button>
    </script>
    ...
    layui.use(['form','layer','laydate','table'], function(){
        ...
        var $ = layui.$, active = {
            ...
            ,reload: function(){
                ...
                console.log(post)
                $.ajax({
                    url: "<?php echo url('admin/Wechat/material_list_info'); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: post,
                    success: function(res) {
